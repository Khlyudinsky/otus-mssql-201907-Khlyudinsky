...
EXEC @RetVal = dbo.tCltAddressInsert 
		...
		@Address        = N'РОССИЯ, 123060, Москва г, , , , Маршала Рыбалко ул, 176, 1,',
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 353901, Краснодарский край, , Новороссийск г, , Портовая ул, 310, , офис 15',
        @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 172124, Тверская обл, Кувшиновский р-н, , Лукино д, , 2, ,',
        @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 309502, Белгородская обл, , Старый Оскол г, , Королева мкр, 5, , 140',
        @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 115093, Москва г, Дубининская ул, д. 394,',
        @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 109316, Москва г,Талалихина ул, д. 41, стр. 13,45',
        @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 352812, Краснодарский край, Туапсинский р-н, , пансионата Гизельдере п, Центральная ул, 2, , 7',
        @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 111024, Москва г, Авиамоторная ул, д. 50, стр. 2, пом. I, комн. 6',
                @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'Ясная Поляна, Крапивенский уезд, Тульская губерния, Российская империя',
        @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 394038, Воронежская обл, , Воронеж г, , Пионеров б-р, 1 В, , 134',
		@ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'Краснодарский край, , Новороссийск г, , Портовая ул, 20, ,4',
        @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 355031, Ставропольский край, , Ставрополь г, , Партизанская ул, 2, , 184',
                @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 361203, Кабардино-Балкарская Респ, , Терек г, , Ленина ул, 53, , 62',
                @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 143072, Московская обл, Одинцовский р-н, , ВНИИССОК п, Рябиновая ул, 34, , 239',
                @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 144001, Московская обл, , Электросталь г, , Октябрьская ул, 5, , 81',
                @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 117638, Москва г, , , , Электролитный проезд, 16, 2, 67',
                @ObjectID      = @AddressID OUTPUT	
...
EXEC @RetVal = dbo.tCltAddressInsert 
		@clientID = @CltID,
		@TypeAddressID     = @TypeAddressID,
		@Address        = N'РОССИЯ, 140186, Московская обл, , Жуковский г, , Солнечная ул, 7, , 213',
                @ObjectID      = @AddressID OUTPUT	
